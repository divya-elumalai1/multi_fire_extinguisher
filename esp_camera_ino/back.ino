...
IPAddress local_IP(192, 168, 0, 51);  // <-- choose an unused IP in your network
...
void setup() {
  ...
  Serial.println("/back/cam-lo.jpg");
  Serial.print("  http://");
  Serial.print(WiFi.localIP());
  Serial.println("/back/cam-mid.jpg");
  Serial.print("  http://");
  Serial.print(WiFi.localIP());
  Serial.println("/back/cam-hi.jpg");
