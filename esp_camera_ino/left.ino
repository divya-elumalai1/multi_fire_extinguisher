...
IPAddress local_IP(192, 168, 0, 53);  // <-- choose an unused IP in your network
...
void setup() {
  ...
  Serial.println("/left/cam-lo.jpg");
  Serial.print("  http://");
  Serial.print(WiFi.localIP());
  Serial.println("/left/cam-mid.jpg");
  Serial.print("  http://");
  Serial.print(WiFi.localIP());
  Serial.println("/left/cam-hi.jpg");
