...
void setup() {
  ...
  // ---- mDNS ----
  if (MDNS.begin("firecam")) {
    Serial.println("mDNS started: http://firecam.local");
  }
  ...
  Serial.println("  http://firecam.local/right/stream");     // live video MPEG
  Serial.println("----live vieo single frame ------");
  Serial.println("  http://firecam.local/right/cam-mid.jpg"); // single Frame
  Serial.println("  http://firecam.local/right/cam-mid.jpg");
  Serial.println("  http://firecam.local/right/cam-mid.jpg");
}
