...
// "http://firecam.local/right/cam-lo.jpg" 
// hit this endpoint and get the ip-address and poll the ip-address
...
// IPAddress local_IP(10, 151, 166, 52);   // <-- new static IP inside hotspot subnet
// IPAddress gateway(10, 151, 166, 190);     // <-- hotspot gateway
