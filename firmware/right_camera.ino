...
void setup() {
 ...
 // cfg.setJpeg(55);
  ...
  // ---- mDNS ----
  if (MDNS.begin("firecamright")) {
    Serial.println("mDNS started: http://firecamright.local");
  }
  ...
  server.on("/right/stream", HTTP_GET, handleMjpegStream);
  ...
  Serial.println("  http://firecamright.local/right/stream");     // live video MPEG
  Serial.println("----live vieo single frame ------");
  Serial.println("  http://firecamright.local/right/cam-mid.jpg"); // single Frame
  Serial.println("  http://firecamright.local/right/cam-mid.jpg");
  Serial.println("  http://firecamright.local/right/cam-mid.jpg");
}
